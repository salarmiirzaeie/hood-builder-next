...
const RestaurantInfoSection: React.FC = () => {
  return (
    <section className="bg-white border-b border-gray-200 text-gray-800 py-16 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto space-y-12">
        {/* Restaurant Safety Measures */}
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 mb-4">Restaurant Safety Measures</h2>
        ...
        {/* HVAC Services */}
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 mb-4">HVAC Services</h2>
          <p className="text-base md:text-lg leading-relaxed">
            ...
            Likewise, when your <span className="font-bold text-blue-700">HVAC system</span> isn't working properly,
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 mb-4">Restaurant Plumbing Services</h2>
          <p className="text-base md:text-lg leading-relaxed">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-lg md:text-xl">
            <span>Arvada</span>
            <span>Aurora</span>
            <span>Boulder</span>
            <span>Brighton</span>
