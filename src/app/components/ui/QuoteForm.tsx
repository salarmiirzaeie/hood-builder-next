...
const QuoteForm: React.FC = () => {
  ...
  return (
    <Element name="contactFormSection">
      {/* Define the scroll target */}
      <div className=" bg-primary flex items-center justify-center p-4 sm:p-6 lg:p-8 font-['Inter']">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="text-white space-y-6">
              <p className="text-lg leading-relaxed">
                We&apos;ve got you covered. Hood Builder is a leading distribution, fabrication, and installation
                company for food facilities of any size. We have offices and plants across the United States that are
                  ...
                  <FormField
                    ...
                    render={({ fieldState }) => (
                      <FormItem className="border border-blue-600 rounded-md p-4">
                        ...
                        {fieldState.error && (
                          <FormMessage className="text-red-300 mt-2 text-center">
